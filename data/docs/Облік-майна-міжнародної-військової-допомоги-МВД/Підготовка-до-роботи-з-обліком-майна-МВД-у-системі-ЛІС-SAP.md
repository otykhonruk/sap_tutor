## Підготовка до роботи з обліком майна МВД у системі (SAP)

Майно МВД відображається у еЗвіті системи за допомогою **групової назви**, без урахування додаткових характеристик (країни походження, кольору, конструктивних особливостей тощо). Групова назва створюється на основі найближчого відповідника позиції норми (групового матеріалу).
...
При обліку майна МВД в ІКС УЛЗ (SAP) на ОЦЗ, використовуються такі саме групові (уніфіковані) назви майна МВД. Як ознаки партії, додається лише країна походження та окрема примітка "МВД".
...
Відповідно, щоб підготуватись до роботи з майном МВД у еЗвіті та у системі, фахівці речових служб мають виконати наступні завдання.
...
III\. Встановити, які найменування майна МВД з тих, з якими працювала в/частина, будуть об'єднані у групові матеріали у еЗвіті системи.
